...
// (workstations w/ monitors, plants).
// ---------------------------------------------------------------------------
...
const INTERIORS: Record<BuildingKey, InteriorSpec> = {
  ...
  OFFICE: {
    ...
    //
    // Middle workstation uses the dual-monitor variant so the cluster
    // reads as three distinct desks. Two plants fill the gaps between
    // workstations.
    //
